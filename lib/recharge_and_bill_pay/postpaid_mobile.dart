...
class PostpaidMobile extends StatefulWidget {
  const PostpaidMobile({Key? key}) : super(key: key);

  @override
  _PostpaidMobileState createState() => _PostpaidMobileState();
}

class _PostpaidMobileState extends State<PostpaidMobile> {
  String? valueChoose;
  String? valueChoose2;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: const Text('POSTPAID MOBILE'),
        ),
        body: Center(
          child: Card(
            elevation: 12,
